 ...
 *
 * @property[productId] The product id of the media product being played.
 * Might differ from requested in case of a replacement.
 * @property[assetPresentation] The asset presentation of the media product being played.
 * Might differ from requested in case of a replacement.
 * @property[duration] The duration, in seconds, of the media product being played.
 * Might differ from the meta data connected to the requested in case of a replacement.
...
sealed interface PlaybackContext {
     ...
     *
     * @param[audioMode] The audio mode of the media product being played (or null).
     * Might differ from requested in case of a replacement.
     * @param[audioQuality] The audio quality of the media product being played (or null).
     * Might differ from requested in case of a replacement.
     * @param[audioBitRate] The bit rate indicated in number of bits per second of the
     * media product being played.
     * @param[audioBitDepth] The bit depth indicated in number of bits used per sample
     * of the media product being played.
     ...
     *
     * @param[streamType] The stream type of the media product being played (or null).
     * Might differ from requested in case of a replacement.
     * @param[videoQuality] The video quality of the media product being played (or null).
     * Might differ from requested in case of a replacement.
     */
    data class Video(
