 ...
 * within. This is important because we should not e.g. release something that is provided from the
 * outside, because it might be in use in other places and will thus create problems.
 */
