 ...
 * which should be used for playback of content that is cached or offlined with aes encryption and
 * a cache key, using a [CacheKeyFactory].
 *
 ...
 * @param[secretKey] A secretKey of [ByteArray]. Must be the same value for the same content
 * when reading from a [DataSource] and writing
 * to a[androidx.media3.datasource.DataSink].
