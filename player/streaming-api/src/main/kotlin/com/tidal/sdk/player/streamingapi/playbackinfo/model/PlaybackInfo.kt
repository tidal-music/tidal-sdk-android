 ...
 * @property[manifest] Base64-encoded manifest for online/BTS. For offline DASH this carries the
 *   http(s) MPD URI loaded from the offline cache; legacy offline downloads may still provide the
 *   base64-encoded MPD, which is parsed in-process for backwards compatibility.
