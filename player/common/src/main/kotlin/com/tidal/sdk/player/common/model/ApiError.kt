...
class ApiError private constructor(
    ...
    /**
     * The different sub status codes sent from our backend.
     * These tell us why something went wrong.
     */
    @Keep
    sealed class SubStatus(open val code: Int) {
        ...
        object UserClientNotAuthorizedForOffline : SubStatus(USER_CLIENT_NOT_AUTHORIZED_FOR_OFFLINE)
        ...
        object NoContentMatchingSubscriptionLocation : SubStatus(
            NO_CONTENT_MATCHING_SUBSCRIPTION_LOCATION,
        )

        object NoContentMatchingSubscriptionConfiguration : SubStatus(
            NO_CONTENT_MATCHING_SUBSCRIPTION_CONFIGURATION,
        )

        object NoContentMatchingClient : SubStatus(NO_CONTENT_MATCHING_CLIENT)
        object NoContentMatchingPrePaywallLocation : SubStatus(
            NO_CONTENT_MATCHING_PRE_PAYWALL_LOCATION,
        )
        ...
        companion object {
            ...
            fun Int?.mapToSubStatus() = when (this) {
                ...
                NO_CONTENT_MATCHING_SUBSCRIPTION_LOCATION -> NoContentMatchingSubscriptionLocation
                NO_CONTENT_MATCHING_SUBSCRIPTION_CONFIGURATION ->
