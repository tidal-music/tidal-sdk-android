...
/**
 * A media product. The [productType] and the [productId] together determine what media product this
 * is. Source information is only used as extra information used for tracking purposes and may be
 * omitted.
 *
