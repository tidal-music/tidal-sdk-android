 ...
 *
 * @param[isOfflineMode] A [Boolean] that tells us if client is in offline mode or not.
 * Must be updated each time the offline mode changes.
 */
class Configuration(isOfflineMode: Boolean) {

    var isOfflineMode by Delegates.observable(isOfflineMode) { _, oldValue, newValue ->
