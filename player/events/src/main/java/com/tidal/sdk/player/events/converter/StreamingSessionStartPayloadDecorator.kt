...
internal class StreamingSessionStartPayloadDecorator(
    @Suppress("MaxLineLength") private val streamingSessionStartDecoratedPayloadFactory: StreamingSessionStart.DecoratedPayload.Factory, // ktlint-disable max-line-length parameter-wrapping
    ...
    fun decorate(payload: StreamingSessionStart.Payload) = payload.run {
