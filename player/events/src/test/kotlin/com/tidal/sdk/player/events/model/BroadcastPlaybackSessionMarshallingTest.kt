...
internal class BroadcastPlaybackSessionMarshallingTest : PlaybackSessionMarshallingTest() {
    ...
    override val payload = BroadcastPlaybackSession.Payload(
    ...
    override val playbackSession = BroadcastPlaybackSession(
        ts,
        UUID.fromString(uuidString),
        user,
        client,
