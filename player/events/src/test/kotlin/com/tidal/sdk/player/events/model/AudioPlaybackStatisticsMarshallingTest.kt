...
internal class AudioPlaybackStatisticsMarshallingTest : PlaybackStatisticsMarshallingTest() {
    ...
    override val payload = AudioPlaybackStatistics.Payload(
        "streamingSessionId",
        Long.MAX_VALUE,
        -7,
        "actualProductId",
    ...
    override val playbackStatistics = AudioPlaybackStatistics(
        ts,
