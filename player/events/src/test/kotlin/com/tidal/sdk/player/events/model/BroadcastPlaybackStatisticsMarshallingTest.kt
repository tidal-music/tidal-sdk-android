...
internal class BroadcastPlaybackStatisticsMarshallingTest : PlaybackStatisticsMarshallingTest() {
    ...
    override val playbackStatistics = BroadcastPlaybackStatistics(
        ts,
