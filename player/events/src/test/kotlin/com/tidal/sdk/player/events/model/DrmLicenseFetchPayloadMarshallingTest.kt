...
internal class DrmLicenseFetchPayloadMarshallingTest {

    private val streamingSessionId = "streamingSessionId"
    private val startTimestamp = 53L
    private val endTimestamp = 0L
    private val payloadFactory: (EndReason, String?, String?) -> DrmLicenseFetch.Payload =
    ...
    private fun testUnmarshallingPayload(
        ...
        val actual = gson.fromJson(src, DrmLicenseFetch.Payload::class.java)
