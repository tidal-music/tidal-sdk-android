...
internal class AudioDownloadStatisticsMarshallingTest : DownloadStatisticsMarshallingTest() {
    ...
    override val client = Client("token", Client.DeviceType.ANDROID_AUTO)
    override val payload = AudioDownloadStatistics.Payload(
        "streamingSessionId",
        0L,
        "actualProductId",
    ...
    override val downloadStatistics = AudioDownloadStatistics(
        ts,
