...
internal class UCPlaybackStatisticsMarshallingTest : PlaybackStatisticsMarshallingTest() {
    ...
    override val playbackStatistics =
        UCPlaybackStatistics(ts, UUID.fromString(uuidString), user, client, payload, emptyMap())
}
