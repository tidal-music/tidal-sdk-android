...
internal class SetStreamingPrivilegesListenerRunnable
@AssistedInject
constructor(
    private val mutableState: MutableState,
    @Assisted private val streamingPrivilegesListener: StreamingPrivilegesListener?,
) : Runnable {

    override fun run() {
        mutableState.streamingPrivilegesListener = streamingPrivilegesListener
        mutableState.connectionMutableState?.streamingPrivilegesListener =
