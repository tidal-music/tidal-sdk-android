...
internal class StreamingPrivilegesDefault(
    ...
    override fun setKeepAlive(newValue: Boolean) =
        networkInteractionsHandler.post(setKeepAliveRunnableFactory.create(newValue))
    ...
    override fun setStreamingPrivilegesListener(
        ...
        networkInteractionsHandler.post(
            setStreamingPrivilegesListenerRunnableFactory.create(streamingPrivilegesListener)
        )

    override fun acquireStreamingPrivileges() =
        mutableState.connectionMutableState?.let {
            networkInteractionsHandler.post(
