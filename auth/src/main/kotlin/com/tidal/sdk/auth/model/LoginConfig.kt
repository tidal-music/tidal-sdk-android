 ...
 * @param customParams Key value map used to add custom parameters to be passed through to the TIDAL
 *   login service. If set to null, a default configuration of TIDAL login service will be applied
 *   (@see [QueryParameter].
 */
