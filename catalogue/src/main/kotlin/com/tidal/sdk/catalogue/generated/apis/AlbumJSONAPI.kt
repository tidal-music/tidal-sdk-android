...
import com.tidal.sdk.catalogue.generated.models.AlbumDataDocument
import com.tidal.sdk.catalogue.generated.models.AlbumRelationshipsDocument
import com.tidal.sdk.catalogue.generated.models.AlbumsDataDocument
import retrofit2.Response
import retrofit2.http.GET
import retrofit2.http.Path
import retrofit2.http.Query

interface AlbumJSONAPI {
    /**
     * Get single album
    ...
    suspend fun getAlbumArtists(
        ...
        @Query("countryCode") countryCode: kotlin.String,
        @Query("include") include: @JvmSuppressWildcards kotlin.collections.List<kotlin.String>? = null,
    ): Response<AlbumRelationshipsDocument>
    ...
    suspend fun getAlbums(
        ...
        @Query("filter[barcodeId]") filterBarcodeId: @JvmSuppressWildcards kotlin.collections.List<kotlin.String>? = null,
    ): Response<AlbumsDataDocument>
