...
interface Playlists {
    ...
    enum class SortPlaylistsGet(val value: kotlin.String) {
        ...
        @SerialName(value = "-createdAt") MinusCreatedAt("-createdAt"),
        @SerialName(value = "lastModifiedAt") lastModifiedAt("lastModifiedAt"),
        @SerialName(value = "-lastModifiedAt") MinusLastModifiedAt("-lastModifiedAt"),
        @SerialName(value = "name") name("name"),
        @SerialName(value = "-name") MinusName("-name"),
    }
