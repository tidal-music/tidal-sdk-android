...
data class ExternalLinkMeta(@SerialName(value = "type") val type: ExternalLinkMeta.Type) {
    ...
    /**
     * Values:
     * TIDAL_SHARING,TIDAL_USER_SHARING,TIDAL_AUTOPLAY_ANDROID,TIDAL_AUTOPLAY_IOS,TIDAL_AUTOPLAY_WEB,TWITTER,FACEBOOK,INSTAGRAM,TIKTOK,SNAPCHAT,OFFICIAL_HOMEPAGE,CASHAPP_CONTRIBUTIONS,ARTIST_CLAIM_PROVIDER_REDIRECT,STRIPE_AUTHORIZATION_REDIRECT,SQUARE_AUTHORIZATION_REDIRECT
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        ...
        @SerialName(value = "ARTIST_CLAIM_PROVIDER_REDIRECT")
        ARTIST_CLAIM_PROVIDER_REDIRECT("ARTIST_CLAIM_PROVIDER_REDIRECT"),
        @SerialName(value = "STRIPE_AUTHORIZATION_REDIRECT")
        STRIPE_AUTHORIZATION_REDIRECT("STRIPE_AUTHORIZATION_REDIRECT"),
        @SerialName(value = "SQUARE_AUTHORIZATION_REDIRECT")
        SQUARE_AUTHORIZATION_REDIRECT("SQUARE_AUTHORIZATION_REDIRECT"),
    }
}
