...
interface UserNewReleaseMixesApi {
    /**
     ...
     *
     * @param id User new release mixes id. Use &#x60;me&#x60; for the authenticated user&#39;s
     *   resource
     ...
     * @return [UserNewReleaseMixesSingleResourceDataDocument]
     */
    @GET("userNewReleaseMixes/{id}")
    suspend fun userNewReleaseMixesIdGet(
