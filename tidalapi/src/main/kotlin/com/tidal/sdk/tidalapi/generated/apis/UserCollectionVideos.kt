...
interface UserCollectionVideos {
    /**
     * GET userCollectionVideos/{id} Get single userCollectionVideo. Retrieves single
     * userCollectionVideo by id. Responses:
     ...
     *
     * @param id User collection videos id. Use &#x60;me&#x60; for the authenticated user&#39;s
     *   resource
    ...
    /**
     * DELETE userCollectionVideos/{id}/relationships/items Delete from items relationship
    ...
    /**
     * GET userCollectionVideos/{id}/relationships/items Get items relationship
    ...
    /**
     * POST userCollectionVideos/{id}/relationships/items Add to items relationship
     ...
     * @return [UserCollectionVideosItemsAddMultiRelationshipDataDocument]
     */
    ...
    suspend fun userCollectionVideosIdRelationshipsItemsPost(
        ...
        userCollectionVideosItemsRelationshipAddOperationPayload:
            UserCollectionVideosItemsRelationshipAddOperationPayload? =
            null,
    ): Response<UserCollectionVideosItemsAddMultiRelationshipDataDocument>

    /**
     * GET userCollectionVideos/{id}/relationships/owners Get owners relationship
