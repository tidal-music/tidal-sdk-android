...
interface TrackManifests {
    ...
    suspend fun trackManifestsIdGet(@Path("id") id: kotlin.String, @Query("manifestType") manifestType: kotlin.String, @Query("formats") formats: kotlin.String, @Query("uriScheme") uriScheme: kotlin.String, @Query("usage") usage: kotlin.String, @Query("adaptive") adaptive: kotlin.String): Response<TrackManifestsSingleDataDocument>
