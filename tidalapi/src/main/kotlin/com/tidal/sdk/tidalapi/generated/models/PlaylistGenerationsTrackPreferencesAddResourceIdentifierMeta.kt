...
/** @param preference */
@Serializable
data class PlaylistGenerationsTrackPreferencesAddResourceIdentifierMeta(
    @SerialName(value = "preference")
    val preference: PlaylistGenerationsTrackPreferencesAddResourceIdentifierMeta.Preference
) {
