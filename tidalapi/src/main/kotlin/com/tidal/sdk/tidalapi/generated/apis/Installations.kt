...
import com.tidal.sdk.tidalapi.generated.models.InstallationsOfflineInventoryAddPayload
import com.tidal.sdk.tidalapi.generated.models.InstallationsOfflineInventoryMultiRelationshipDataDocument
import com.tidal.sdk.tidalapi.generated.models.InstallationsOfflineInventoryRemovePayload
...
interface Installations {
     ...
     *
     * @param id Installation id
     * @param installationsOfflineInventoryRemovePayload (optional)
     * @return [Unit]
     */
    @HTTP(
        method = "DELETE",
    ...
    suspend fun installationsIdRelationshipsOfflineInventoryDelete(
        @Path("id") id: kotlin.String,
        @Body
        installationsOfflineInventoryRemovePayload: InstallationsOfflineInventoryRemovePayload? =
            null,
    ): Response<Unit>
     ...
     *
     * @param id Installation id
     * @param installationsOfflineInventoryAddPayload (optional)
     * @return [Unit]
     */
    ...
    suspend fun installationsIdRelationshipsOfflineInventoryPost(
        @Path("id") id: kotlin.String,
        @Body
        installationsOfflineInventoryAddPayload: InstallationsOfflineInventoryAddPayload? = null,
    ): Response<Unit>
