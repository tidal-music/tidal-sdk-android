...
import com.tidal.sdk.tidalapi.generated.models.UpdateUserPublicProfilePicksRelationshipDocument
import com.tidal.sdk.tidalapi.generated.models.UserPublicProfilePicksItemRelationshipDocument
...
interface UserPublicProfilePicks {
     ...
     * @return [UserPublicProfilePicksItemRelationshipDocument]
     */
    ...
    suspend fun getUserPublicProfilePickItemRelationship(
        ...
        @Query("locale") locale: kotlin.String,
        @Query("include") include: @JvmSuppressWildcards kotlin.collections.List<kotlin.String>? = null,
    ): Response<UserPublicProfilePicksItemRelationshipDocument>
     ...
     *
     * @param id TIDAL pick id
     * @param updateUserPublicProfilePicksRelationshipDocument
    ...
    suspend fun setUserPublicProfilePickItemRelationship(
        @Path("id") id: kotlin.String,
        @Body updateUserPublicProfilePicksRelationshipDocument:
        UpdateUserPublicProfilePicksRelationshipDocument,
        @Query("include") include: @JvmSuppressWildcards kotlin.collections.List<kotlin.String>? = null,
    ): Response<kotlin.Any>
}
