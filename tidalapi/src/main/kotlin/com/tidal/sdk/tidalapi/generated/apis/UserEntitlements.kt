...
import com.tidal.sdk.tidalapi.generated.models.UserEntitlementsMultiRelationshipDataDocument
...
interface UserEntitlements {
     ...
     * @return [UserEntitlementsMultiRelationshipDataDocument]
     */
    @GET("userEntitlements/{id}/relationships/owners")
    suspend fun userEntitlementsIdRelationshipsOwnersGet(
        @Path("id") id: kotlin.String,
        @Query("include")
        include: @JvmSuppressWildcards kotlin.collections.List<kotlin.String>? = null,
        @Query("page[cursor]") pageCursor: kotlin.String? = null,
    ): Response<UserEntitlementsMultiRelationshipDataDocument>
}
