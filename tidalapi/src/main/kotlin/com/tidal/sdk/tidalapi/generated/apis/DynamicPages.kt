...
interface DynamicPages {
    ...
    enum class PlatformDynamicPagesGet(val value: kotlin.String) {
     ...
     * @param platform The platform of the device making the request
    ...
    suspend fun dynamicPagesGet(
        ...
        @Query("platform") platform: PlatformDynamicPagesGet,
