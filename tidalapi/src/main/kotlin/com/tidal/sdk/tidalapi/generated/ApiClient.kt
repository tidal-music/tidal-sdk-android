...
class TidalApiClient(credentialsProvider: CredentialsProvider, baseUrl: String = DEFAULT_BASE_URL) {
    ...
    */
    ...
    /**
    * Returns an instance of the [Artworks] which can be used
    * to make API calls to the 
    */
    ...
    */
    ...
    /**
    * Returns an instance of the [SearchSuggestions] which can be used
    * to make API calls to the 
    */
    ...
    */
    ...
    /**
    * Returns an instance of the [TrackFiles] which can be used
    * to make API calls to the 
    */
    ...
    /**
    * Returns an instance of the [TrackManifests] which can be used
    * to make API calls to the 
    */
