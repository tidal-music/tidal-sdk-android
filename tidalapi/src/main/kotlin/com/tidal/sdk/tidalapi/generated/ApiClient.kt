...
import com.tidal.sdk.tidalapi.generated.apis.ArtistClaimStatuses
...
class TidalApiClient(
    ...
    /**
     * Returns an instance of the [ArtistClaimStatuses] which can be used to make API calls to the
     */
    fun createArtistClaimStatuses(): ArtistClaimStatuses {
        return retrofit.create(ArtistClaimStatuses::class.java)
    }
