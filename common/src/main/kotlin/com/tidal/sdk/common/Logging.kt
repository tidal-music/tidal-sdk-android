...
/**
 * @return a logger with the name of the class that calls this extension function
 * Loggers are stored in a map and reused
 */
...
fun getLoggerByName(name: String): KLogger {
    return LOGGER_MAP.getOrPut(name) {
...
/**
 * verbose is generally considered a synonym of trace,
 * so to stay in line with typical logging frameworks
 * on Android, we add this convenience function
 */
